...
export function TeamCard({ img, name, position }) {
  return (
    <Card
      color="transparent"
      shadow={false}
      className="flex flex-col items-center justify-center text-center transition-all duration-300 hover:scale-110 "
    >
      <Avatar
        src={img}
        alt={name}
      ...
      {position && (
        <Typography className="text-lg font-normal text-gray-700">
          {position}
        </Typography>
      )}
    </Card>
