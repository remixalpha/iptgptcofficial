          ...
          {isEdit ? (
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 xl:grid-cols-2  ">
              ...
              <div className="space-y-10">
                ...
                <div className=" flex items-center justify-end gap-x-6 relative top-[8rem] ">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg ">
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 xl:grid-cols-2">
              ...
              <div className="space-y-10">
                ...
                <div className="group flex flex-col justify-end items-end relative top-[10rem] cursor-pointer">
                  <div className="relative">
                    <PiUploadSimpleThin
                      type="submit"
                      className="h-10 w-10 p-1 text-navy-900 transition-transform duration-300 ease-in-out transform group-hover:-translate-y-4"
