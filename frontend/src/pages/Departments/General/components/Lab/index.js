...
export default function Content() {
  return (
    <div className="relative grid grid-cols-1 space-y-10 bg-lightPrimary h-auto w-auto rounded-3xl mb-8 mx-auto max-w-2xl items-center gap-x-2 px-4 sm:py-10 lg:max-w-2xl lg:grid-cols-1">
      <div className="absolute top-8  left-1/2 transform -translate-x-1/2 bg-white scale-125 rounded-full w-12 h-12 flex items-center justify-center shadow-lg ">
        {/* Add the lab icon */}
