    ...
    <footer className="relative w-full bg-gray-800 ">
      <div className="w-full px-8 mx-auto max-w-7xl">
        <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
          <div className="flex items-start flex-shrink-0 mt-10 ">
            <img className="h-[3rem ] w-auto" src={Logo} alt="IPT LOGO" />
          </div>
        </div>
        <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-blue-gray-50 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear}{" "}
            <a href="https://material-tailwind.com/">Copy Right</a> : IPT & GPTC
            SHORANUR
          </Typography>
